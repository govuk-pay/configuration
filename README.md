...
GitHub users and their permissions are pulled from the [pay-access-control](https://github.com/govuk-pay/pay-access-control) repository. This is aligned with GOV.UK Pay's access control policy to manage permissions for team members.
